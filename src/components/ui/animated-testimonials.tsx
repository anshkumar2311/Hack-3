        ...
        <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20">
            <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 mt-4">
                    The creative forces driving SocialAnalytics, uniting innovation, technical expertise, and a shared passion for crafting impactful solutions in development, data science, and user experience design."
                </p>
            </div>
